...
void GraphicsObjects::CreateFence(ID3D12Device* device)
{
	ThrowIfFailed(device->CreateFence(0, D3D12_FENCE_FLAG_NONE, IID_PPV_ARGS(&mFence)));

}

void GraphicsObjects::CreateCommandObjects(ID3D12Device* device)
{
...
void GraphicsObjects::FlushCommandQueue()
{
